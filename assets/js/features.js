...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Mit Pune</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>MIT Pune Canteen</p>
                        <ul class="py-1">
                            <li><i class="fab fa-linkedin"></i><a href="https://www.linkedin.com/in/harshranjan77/" target="_blank"> Linkedin</a></li>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://github.com/harshra215/" target="_blank">Git Repository</a></li>
                            <li><a href="https://harshrportfolio.netlify.app/" target="_blank">Harsh</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-932-44351-63</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>hr062774@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Pune-IN </p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p></p></li>
                        </ul>
                    </article>
                </main>
                <!-- Harsh Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Developed <i class="fas fa-heart clr-red"></i> By <a href="#">Harsh Ranjan</a></div>
                </main>
            </section>
        `;
        })
    ...
    if (userFooter){
        userFooter.forEach(element => {
            ...
            <!-- Upper Footer -->
                ...
                <main class="deep-devs flex">
                    <div>© Copyright 2024. All Rights Reserved</div>
                    <div class="">Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Harsh</a></div>
                </main>
            </section>
        `;
        })
